...
- **Нижний колонтитул**: Показывает статистику сессии, такую как скорости загрузки/выгрузки и свободное место на диске, версию сервера Transmission
...
5. Чтобы скопировать путь в буфер обмена, нажмите на иконку буфера обмена рядом с путем в настройках

### Управление путями загрузки в настройках

Для управления путями загрузки непосредственно в настройках приложения:

1. Нажмите на значок настроек в заголовке
2. Выберите вкладку "Пути загрузки"
3. Вы увидите список всех сохраненных каталогов загрузки
4. Чтобы установить каталог по умолчанию, нажмите на иконку звезды рядом с ним
5. Чтобы удалить каталог, нажмите на иконку корзины рядом с ним
6. Чтобы скопировать путь каталога в буфер обмена, нажмите на иконку буфера обмена рядом с путем
   - Иконка на короткое время изменится на галочку при успешном копировании
   - В случае ошибки при копировании иконка покажет индикатор ошибки
...
5. Также можно удалить отдельный торрент, нажав на иконку корзины на его карточке.
...
3. Также можно переключить медленный режим для отдельного торрента, нажав на иконку улитки на его карточке
...
- **В очереди**: Торрент стоит в очереди на загрузку/выгрузку/проверку данных
