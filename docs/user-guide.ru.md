...
Основной интерфейс Transmission Client Go разделен на несколько областей:
...
- **Нижний колонтитул**: Показывает статистику сессии, такую как скорости загрузки/выгрузки и общий объем завершенных
...
### Просмотр сведений о торренте

Для просмотра подробной информации о торренте:

1. Нажмите на торрент в списке торрентов
2. Откроется подробный просмотр, показывающий:
   - Общую информацию (размер, прогресс, рейтинг и т.д.)
   - Список файлов с индивидуальным прогрессом каждого файла
   - Информацию о пирах
...
1. Нажмите на торрент, чтобы просмотреть его подробности
2. На вкладке "Файлы" вы увидите список всех файлов в торренте
3. Снимите отметки с файлов, которые вы не хотите загружать
...
1. Выберите один или несколько торрентов в списке, нажав на них (удерживайте Ctrl или Cmd для выбора нескольких)
